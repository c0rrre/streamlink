...
def parse_arguments():
    ...
    parser.add_argument("-recordingsizelimit", type=int, default=0, help="Older recordings will be deleted so the remaining will take up space upto the given limit in MBs")
    parser.add_argument("-recordingretention", type=int, default=0, help="Recording older than the given limit (in days) will be deleted")
    parser.add_argument("-notifyonstartup", type=bool, default=True, help="Send a notification on startup")
